...
const firebaseConfig = {
  apiKey: "AIzaSyAtshnjDWJN8v7fIRwIFt3oJ_Ou9-pj0qk",
  authDomain: "haulytics-db343.firebaseapp.com",
  projectId: "haulytics-db343",
  storageBucket: "haulytics-db343.firebasestorage.app",
  messagingSenderId: "1016209723533",
  appId: "1:1016209723533:web:84b2815072eeb6f3fc52c4",
  measurementId: "G-ND1L8KBZQD"
};
...
export default function HaulyticsDashboard() {
  ...
  const addFleetVehicle = async () => {
    const newVehicle = { id: Date.now().toString(), truckId: '', make: '', model: '', year: new Date().getFullYear(), type: 'Prime Mover', capacity: 0, fuelTankSize: 400, tyreSize: '315/80R22.5', assetValue: 0, financing: { term: 5, interestRate: 9.0, monthlyPayment: 0 }, insurance: 0, licensing: 0, tracking: 150 };
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg border border-gray-200" style={{borderColor: PRIMARY_COLOR}}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label htmlFor="kmValueInput" className="block text-sm font-medium mb-1">Kilometers Driven</label><input id="kmValueInput" type="number" value={kmValue} onChange={(e) => setKmValue(e.target.value)} placeholder="e.g., 500" className="w-full p-2 border rounded" style={{ borderColor: PRIMARY_COLOR }}/></div>
              </div>
